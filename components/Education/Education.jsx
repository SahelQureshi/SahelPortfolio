  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute inset-0 -z-10">
        <div className={`absolute -top-40 -left-20 h-96 w-96 rounded-full bg-gradient-to-br from-emerald-500/30 to-cyan-600/20 blur-3xl ${!disableAnimations ? 'css-float' : ''}`} />
        <div className={`absolute -bottom-40 -right-20 h-96 w-96 rounded-full bg-gradient-to-br from-purple-500/30 to-pink-600/20 blur-3xl ${!disableAnimations ? 'css-float' : ''}`} style={!disableAnimations ? { animationDelay: '2s' } : {}} />
        <div className={`absolute top-1/4 right-1/4 h-64 w-64 rounded-full bg-gradient-to-br from-blue-500/20 to-indigo-500/15 blur-3xl ${!disableAnimations ? 'css-float' : ''}`} style={!disableAnimations ? { animationDelay: '4s' } : {}} />
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16">
          ...
          <div className="lg:col-span-7">
            <div className="relative">
              ...
              <div
                ref={timelineRef}
                className="absolute sm:block hidden left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-emerald-400 via-cyan-400 to-purple-500 rounded-full shadow-lg"
              ...
              {education.map((item, index) => (
                ...
                >
                  {/* Timeline node */}
                  <div className="absolute sm:flex hidden left-4 top-8 w-8 h-8 rounded-full bg-gradient-to-br from-emerald-400 to-cyan-500 border-4 border-gray-900 shadow-lg z-10 items-center justify-center">
          ...
          <div className="lg:col-span-5">
            <div className="sticky top-24 space-y-8">
              ...
              <div className="group relative">
                <div className={`absolute -inset-2 bg-gradient-to-r from-emerald-500/20 via-cyan-500/15 to-purple-500/20 rounded-3xl blur-xl ${!disableAnimations ? 'opacity-60 group-hover:opacity-80 transition-opacity duration-1000' : ''}`} />
